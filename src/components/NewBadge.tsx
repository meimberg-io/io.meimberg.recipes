...
export default function NewBadge({ createdTime }: NewBadgeProps) {
  ...
  return (
    <span className="absolute top-2 left-2 z-10 rounded-full bg-emerald-500 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-white shadow-md">
      Neu
    </span>
  )
}
